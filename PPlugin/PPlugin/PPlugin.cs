...
namespace PPlugin
{
    ...
    public class PPlugin : Plugin
    {
        ...
        public readonly string[] tips = new[] { "Из монеты в <color=red>SCP-914</color> можно сделать карту уборщика",
            ...
            "Игрок! Уважай и слушайся администрацию сервера!" +
            "Будь уважителен к другим игрокам",
            "не используй читы. Не порть другим игровой процесс",
            "Иногда вещи могут быть в самых неожиданных местах",
            "Игрок! Не поленись,зайди на <color=red>DISCORD</color> сервер проекта! (ссылка в <color=red>INFO</color>",
        };

        public readonly string[] rusNames = new[] { "Егор", "Влад", "Слава", "Ярослав", "Гена", "Женя", "Саша", "Артём", "Миша", "Иван", "Игорь", "Данил", "Киррил" };
